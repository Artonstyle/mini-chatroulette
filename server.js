...
// ADMIN
const adminCredentials = { username: 'admin', password: 'Arton.190388' };
...
app.get('/admin/reports', (req,res) => {
    ...
    if (fs.existsSync(reportsPath)) res.sendFile(reportsPath);
    else res.type('text/plain').send("Noch keine Reports vorhanden.");
});
